export function getRouters(filters) {
  const routers = [
    /** 车辆监控 */
    {
      path: '/cljk/yyts',
      name: '营运态势',
      component: () => import('views/vehicle-monitor/OperationalSituation.vue')
    },
    {
      path: '/cljk/wzjk',
      name: '位置监控',
    ...
    },
    {
      path: '/cljk/dcjk',
      name: '多车监控',
      component: () => import('views/vehicle-monitor/MultiVehicleMonitor.vue')
    },
    {
      path: '/cljk/fpjk',
      name: '分屏监控',
      component: () => import('views/vehicle-monitor/SplitScreenMonitor.vue')
    },
    {
      path: '/cljk/lsgj',
      name: '历史轨迹',
    ...
    },
    {
      path: '/cljk/yyjlcx',
      name: '营运记录查询',
      component: () => import('views/query-analysis/OperationRecordInquiry.vue')
    },
    {
      path: '/cljk/yysjtj',
      name: '营运数据统计',
    ...
    },
    {
      path: '/cljk/yyyb',
      name: '营运月报',
      component: () => import('views/query-analysis/OperatingMonthlyReport.vue')
    },
    {
      path: '/cljk/wxjlcx',
      name: '维修记录查询',
    ...
    },
    {
      path: '/cljk/xxjlcx',
      name: '消息记录查询',
      component: () => import('views/query-analysis/MessageRecordQuery.vue')
    },
    {
      path: '/cljk/wzcx',
      name: '违章查询',
    ...
    /**数据查询 */
    {
      path: '/sjtj/szltj',
      name: '实载率统计',
      component: () => import('views/data-statistics/MileageStatistics.vue')
    },
    {
      path: '/sjtj/dccltj',
      name: '单车里程统计',
    ...
    },
    {
      path: '/sjtj/wyysj',
      name: '无营运数据车辆',
      component: () => import('views/data-statistics/NoCampDataVehicle.vue')
    },
    {
      path: '/sjtj/wsxcl',
      name: '未上线车辆查询',
    ...
    },
    {
      path: '/sjtj/wsxwyy',
      name: '未上线未营运车辆',
      component: () => import('views/data-statistics/UnoperatedVehicle.vue')
    },
    {
      path: '/sjtj/wkzcbh',
      name: '无空重车变化车辆',
    ...
    },
    {
      path: '/jcsj/dzwlgl',
      name: '电子围栏管理',
      component: () => import('views/basic-data/ElectronicFenceManage.vue')
    },
    {
      path: '/jcsj/ptsyjl',
      name: '平台使用记录',
    ...
    },
    {
      path: '/hjgl/zcsq',
      name: '转出申请',
      component: () => import('views/mail-manage/OutTransferApplication.vue')
    },
    {
      path: '/hjgl/btsq',
      name: '报停申请',
    ...
    },
    {
      path: '/hjgl/zctj',
      name: '转出统计',
      component: () => import('views/mail-manage/OutTransferStatistics.vue')
    },
    {
      path: '/hjgl/bttj',
      name: '报停统计',
