...
<template>
  <t-query-panel :model="query" footer="300">
    ...
    <t-table-page :data="table.data" :loading="table.display" :page-size="20">
      ...
      <el-table-column prop="COMP_NAME" label="公司" align="center" width="240"></el-table-column>
      <el-table-column prop="VEHI_NO" label="车牌号码" align="center" width="240"></el-table-column>
      <el-table-column prop="VEHI_SIM" label="SIM卡号" align="center" width="280"></el-table-column>
      <el-table-column prop="OWN_NAME" label="联系人" align="center" width="280"></el-table-column>
      <el-table-column prop="OWN_TEL" label="联系电话" align="center" min-width="320" :resizable="false"></el-table-column>
    </t-table-page>
  </t-query-panel>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      findNoCampDataVehicle() {
        ...
        axios.get('dataStatistics/findNoCampDataVehicle', {
          baseURL,
          params: {
      ...
      handleExportClick() {
        ...
        this.$confirm('是否需要导出?', '提示', {
          ...
          window.open(`${baseURL}dataStatistics/findNoCampDataVehicleExcel?startTime=${startTime && moment(startTime).format('YYYY-MM-DD')}&endTime=${endTime && moment(endTime).format('YYYY-MM-DD')}&company=${company}&vehicleGroupId=${vehicleGroupId}`);
        }).catch(() => {
